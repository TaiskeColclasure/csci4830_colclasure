...
\begin{itemize}
        ...
        \item[e.]Use your results to write an equation for the fraction of initially infected people who are still in the infected state at time t.
        \item[f.]This formula produces values between 0 and 1, and it tells us the probability that a ran  omly chosen infected person is still infected at time t. In other words, you have written a cumulative distribution function or CDF, telling us the probability that someone is infected for at least t units of time. Take a derivative of this function to turn your CDF into a PDF. Then, find out what this famous probability distribution is called, and write down its expected value.
        \item[g.]se your results to explain how the recovery rate γ is related to the typical amount of t me a person remains infectious.
\end{itemize}
}
\begin{itemize}
                \begin{item}[a)]
